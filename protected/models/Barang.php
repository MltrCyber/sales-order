...
class Barang extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('kode, nama, harga, satuan', 'required'),
            array('stok, harga', 'numerical'),
            array('kode', 'length', 'max' => 10),
            array('nama', 'length', 'max' => 100),
            array('harga', 'length', 'max' => 20),
            array('satuan', 'length', 'max' => 15),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, kode, nama, harga, satuan, stok', 'safe', 'on' => 'search'),
        );
    }
    
    public function getHargaBrg(){
        return Yii::app()->tindik->rupiah($this->harga);
    }
